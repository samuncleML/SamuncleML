...
accuracy_disease = Accuracy(task='multiclass', num_classes=26).to(device)
...
for epoch in range(1, epochs+1):
    ...
    for image, crop, disease in train_loader:
        ...
        f1score_plant.update(plant_outputs.squeeze(1), crop)
        accuracy_plant.update(plant_outputs.squeeze(1), crop)
