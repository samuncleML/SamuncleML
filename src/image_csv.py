...
path = r'C:\Users\Administrator\Documents\plant-disease-multhead\plant'
...
image_csv = Image_data.to_csv(r'C:\Users\Administrator\Documents\plant-disease-multhead\crop_disease_labels.csv', index=False)
